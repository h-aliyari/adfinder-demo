...
export default function ForgotPasswordPage() {
  ...
  // این هندلرها و state ها مربوط به فرم ارسال ایمیل هستند،
  // و به نظر نمی رسد که از useSearchParams استفاده کنند.
  // اما کامپوننت ActualForgotPasswordComponent ممکن است استفاده کند.
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
